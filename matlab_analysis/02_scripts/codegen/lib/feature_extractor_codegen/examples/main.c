...
#include "feature_extractor_codegen_emxAPI.h"
...
static emxArray_real_T *argInit_Unboundedx6_real_T(void);
...
void main_feature_extractor_codegen(void)
{
  ...
  raw_data = argInit_Unboundedx6_real_T();
  /* Call the entry-point 'feature_extractor_codegen'. */
  feature_extractor_codegen(raw_data, argInit_real_T(), features);
  emxDestroyArray_real_T(raw_data);
}
