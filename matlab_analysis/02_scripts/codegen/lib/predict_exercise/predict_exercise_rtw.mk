...
COMPILER_COMMAND_FILE     = predict_exercise_rtw_comp.rsp
CMD_FILE                  = predict_exercise_rtw.rsp
C_STANDARD_OPTS           = -fwrapv
CPP_STANDARD_OPTS         = -fwrapv
MODELLIB                  = predict_exercise.lib
...
DEFINES_CUSTOM = 
DEFINES_STANDARD = -DMODEL=predict_exercise
...
%.obj : $(START_DIR)/codegen/lib/predict_exercise/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/codegen/lib/predict_exercise/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/codegen/lib/predict_exercise/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/codegen/lib/predict_exercise/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/codegen/lib/predict_exercise/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
predict_exercise_data.obj : $(START_DIR)/codegen/lib/predict_exercise/predict_exercise_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.obj : $(START_DIR)/codegen/lib/predict_exercise/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.obj : $(START_DIR)/codegen/lib/predict_exercise/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.obj : $(START_DIR)/codegen/lib/predict_exercise/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


predict_exercise_initialize.obj : $(START_DIR)/codegen/lib/predict_exercise/predict_exercise_initialize.c
	$(CC) $(CFLAGS) -o "$@" "$<"


predict_exercise_terminate.obj : $(START_DIR)/codegen/lib/predict_exercise/predict_exercise_terminate.c
	$(CC) $(CFLAGS) -o "$@" "$<"


predict_exercise.obj : $(START_DIR)/codegen/lib/predict_exercise/predict_exercise.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
strtrim.obj : $(START_DIR)/codegen/lib/predict_exercise/strtrim.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
introsort.obj : $(START_DIR)/codegen/lib/predict_exercise/introsort.c
	$(CC) $(CFLAGS) -o "$@" "$<"
