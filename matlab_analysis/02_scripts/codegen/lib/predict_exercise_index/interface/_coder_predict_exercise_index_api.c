 ...
 *
 * _coder_predict_exercise_index_api.c
 *
...
emlrtContext emlrtContextGlobal = {
    ...
    NULL,                                                 /* fErrorFunction */
    "predict_exercise_index",                             /* fFunctionName */
    NULL,                                                 /* fRTCallStack */
    false,                                                /* bDebugMode */
...
void predict_exercise_index_api(const mxArray *prhs, const mxArray **plhs)
{
  ...
  idx = predict_exercise_index(*features);
  /* Marshall function outputs */
  *plhs = emlrt_marshallOut(idx);
}
...
void predict_exercise_index_atexit(void)
{
  ...
  predict_exercise_index_xil_terminate();
  predict_exercise_index_xil_shutdown();
  emlrtExitTimeCleanup(&emlrtContextGlobal);
}
...
/* End of code generation (_coder_predict_exercise_index_api.c) */
